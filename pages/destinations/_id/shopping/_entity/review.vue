<template>
  ...
  <main id="main" class="site-main bg-primary">
    ...
    <div class="back-to dest-back-to">
      <div class="container">
        <nuxt-link :to="localePath({name: 'destinations-id-shopping-entity', params: $route.params})">Back to
          {{ item.title }}
        </nuxt-link>
      </div>
    </div>
...
<script>
  ...
  export default {
    name: "DestinationShoppingReview",
    ...
    methods: {
      async createReview() {
        ...
        try {
          ...
          this.$router.push({
            name: `destinations-id-shopping-entity`,
