<template>
  <main id="main" class="site-main">
    ...
    <div class="back-to dest-back-to bg-primary">
      <div class="container">
        <nuxt-link :to="localePath({name: 'destinations-id-hotels', params: $route.params})">Back to
          Hotels
        </nuxt-link>
      </div>
    </div>
          ...
          <div class="dest-info col-12 col-lg-5">
            ...
            <div class="item-metas item-metas--bot">
              ...
              <div class="item-meta item-meta-add-review">
                <nuxt-link :to="localePath({name: 'destinations-id-hotels-entity-review', params: $route.params})">
                  Add a review
                </nuxt-link>
              </div>
            </div>
                  ...
                  <ul class="gallery row row-xs">
                    ...
                    <li class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2">
                      <div class="gallery-extra">
                        <nuxt-link :to="localePath({name: 'destinations-id-hotels-entity-images', params: $route.params})">
                          See All
                        </nuxt-link>
                      </div>
                    </li>
