          ...
          <div class="dest-info col-12 col-lg-5">
            ...
            <div class="item-metas item-metas--bot">
              ...
              <div class="item-meta item-meta-add-review">
                <nuxt-link :to="localePath({name: 'destinations-id-restaurants-entity-review', params: $route.params})">
                  Add a review
                </nuxt-link>
              </div>
            </div>
                  ...
                  <ul class="gallery row row-xs">
                    ...
                    <li class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2">
                      <div class="gallery-extra">
                        <nuxt-link :to="localePath({name: 'destinations-id-restaurants-entity-images', params: $route.params})">
                          See All
                        </nuxt-link>
                      </div>
                    </li>
