            ...
            <ul class="items items--list items--hotels">
              <li class="item" :class="{'item--favored': item.is_liked}" v-for="(item, index) in items">
                <div class="item-wrap">
                  ...
                  <nuxt-link :to="localePath({name: 'destinations-id-museums-entity', params: {...$route.params, entity: item.id}})" class="item-img">
                    <img :src="item.cover"
                         width="530"
                         height="320"
                         :title="item.title"
                  ...
                  <div class="item-body">
                    <h4 class="item-title"><nuxt-link :to="localePath({name: 'destinations-id-museums-entity', params: {...$route.params, entity: item.id}})" v-text="item.title"></nuxt-link></h4>
