<template>
  <main id="main" class="site-main">
    ...
    <div class="back-to dest-back-to bg-primary">
      <div class="container">
        <nuxt-link :to="localePath({name: 'destinations-destination-events', params: $route.params})">Back to Events
        </nuxt-link>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="dest-info col-12 col-lg-5">
            ...
            <div class="item-content">
              ...
              <div class="item-form">
                <form>
                  <div class="form-group form-price">${{ event.base_price | formatMoney}}</div>
            ...
            <div class="item-metas item-metas--bot">
               <div class="item-meta item-meta-favorite" :class="{active: event.is_liked}">
                <a href="#"
