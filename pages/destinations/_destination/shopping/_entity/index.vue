<template>
  <main id="main" class="site-main">
    ...
    <div class="back-to dest-back-to bg-primary">
      <div class="container">
        <nuxt-link :to="localePath({name: 'destinations-destination-shopping', params: $route.params})">Back
          to Shopping
        </nuxt-link>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="dest-info">
            ...
            <div class="item-content">
              <div class="ic-row ic-row-address" v-text="item.address">
              </div>
            ...
            <div class="item-metas item-metas--bot">
              ...
              <div class="item-meta item-meta-add-review">
                <nuxt-link :to="localePath({name: 'destinations-destination-shopping-entity-review', params: $route.params})">
                  Add a review
                </nuxt-link>
              </div>
            </div>
