<template>
  <li class="item"
      :class="{'item--favored': item.is_liked}"
  <div class="item-wrap">
    ...
    <div class="item-body">
      <h4 class="item-title">
        <nuxt-link :to="localePath({name: 'destinations-destination-restaurants-entity', params: {entity: item.id, ...$route.params}})"
  ...
  export default {
    ...
    props: {
      ...
      route: {
        required: false,
        default() {
          return {name: 'destinations-destination-restaurants-entity', params: {...this.$route.params, entity: this.item.route_key}}
        }
      }
    },
    ...
    methods: {
      ...
      ...mapActions('restaurants', ['favorite', 'unfavorite']),
