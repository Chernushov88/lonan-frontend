<template>
  <li class="item"
    ...
    <div class="item-wrap">
      ...
      <div class="item-body">
        <h4 class="item-title">
          <nuxt-link :to="localePath({name: 'destinations-destination-hotels-entity', params: {...$route.params, entity: item.id}})"
  ...
  export default {
    ...
    props: {
      ...
      route: {
        required: false,
        default() {
          return {name: 'destinations-destination-hotels-entity', params: {...this.$route.params, entity: this.item.route_key}}
        }
      }
    },
    ...
    methods: {
      ...
      ...mapActions('hotels', ['favorite', 'unfavorite']),
